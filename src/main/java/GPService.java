...
//        new GPService().gpfdistTest();
    ...
    public void gpfdistTest(){
        //开启gpfdist服务
        SSHCommandExecutor sshExecutor = new SSHCommandExecutor("192.168.18.211", "gpadmin", "gpadmin");
        ...
        //通过sftp上传文件
        ChannelSftp sftp=connect("192.168.18.211",22,"root","root");
    ...
    public void importData(){
        ...
        try {
            ...
            sql="create external table ebike_record_ext (" +
                    ...
                    ") location ('gpfdist://192.168.18.211:8088/ebike_record.txt') " +
...
//                System.out.println(num);
    ...
    public void outputData(){
        String sql="create writable external table ebike_record_out_ext (" +
                ...
                "RESIDENCE_ID varchar(32)  ," +
                "COMMUNITY_ID varchar(32)   " +
                ") location ('gpfdist://192.168.18.211:8088/ebike_record_out.txt') " +
                "format 'TEXT' (delimiter as '|' null as '');";
